                              ...
                              children: [
                                ...
                                Padding(
                                  padding: EdgeInsetsDirectional.fromSTEB(
                                      8, 8, 8, 8),
                                  child: FutureBuilder<
                                      List<ViewSaldofinalporusuarioRow>>(
                                    future: ViewSaldofinalporusuarioTable()
                                        .querySingleRow(
                                      queryFn: (q) => q.eqOrNull(
                                        'usuario',
                                        currentUserUid,
                                    ...
                                    builder: (context, snapshot) {
                                      ...
                                      List<ViewSaldofinalporusuarioRow>
                                          totaisViewSaldofinalporusuarioRowList =
                                          snapshot.data!;

                                      final totaisViewSaldofinalporusuarioRow =
                                          totaisViewSaldofinalporusuarioRowList
                                                  .isNotEmpty
                                              ? totaisViewSaldofinalporusuarioRowList
                                                  .first
                                                        ...
                                                        children: [
                                                          ...
                                                          Text(
                                                            valueOrDefault<
                                                                String>(
                                                              formatNumber(
                                                                totaisViewSaldofinalporusuarioRow
                                                                    ?.saldoFinal,
                                                                formatType:
                                                                    FormatType
                                                                        .decimal,
